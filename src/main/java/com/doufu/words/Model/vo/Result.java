...
public class Result<T> implements Serializable {
	...
	public static final String DEFAULT_OVERTIME_CODE = "20001";

	public static final String DEFAULT_OVERTIME_MESSAGE = "登录超时，请重新登录";
...
//	}
	...
	public static <T> Result<T> createOverTime() {
		Result<T> result = new Result<T>(DEFAULT_OVERTIME_CODE, DEFAULT_OVERTIME_MESSAGE);
		return result;
	}

	public static <T> Result<T> createOverTime(String message) {
		Result<T> result = new Result<T>(DEFAULT_OVERTIME_CODE, message);
		return result;
	}

	public static <T> Result<T> createOverTime(T data) {
		Result<T> result = new Result<T>(DEFAULT_OVERTIME_CODE, DEFAULT_OVERTIME_MESSAGE, data);
		return result;
	}

	public static <T> Result<T> createOverTime(String message, T data) {
		Result<T> result = new Result<T>(DEFAULT_OVERTIME_CODE, message, data);
		return result;
	}
